# Generated by Django 4.2.8 on 2023-12-15 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_servico', models.CharField(choices=[('Unhas', 'Unhas'), ('Cabelereiro', 'Cabelereiro'), ('Cosmédicos', 'Cosmédicos')], max_length=50, verbose_name='Tipo de serviço')),
